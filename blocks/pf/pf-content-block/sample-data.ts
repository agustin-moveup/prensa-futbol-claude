import type { PfContentBlockFeaturesProps, PfContentBlockFaqProps } from "./component";

const featuresDefault: PfContentBlockFeaturesProps = {
  variant: "features",
  ...
  items: [
    {
      icon: "shield",
      title: "Casas licenciadas y reguladas",
      body: "Solo recomendamos operadoras con licencia vigente, garantizando que tu dinero y datos estén protegidos.",
    },
    {
      icon: "chart",
      title: "Cuotas y mercados analizados",
      body: "Comparamos cuotas en tiempo real para que siempre encuentres el mejor valor antes de apostar.",
    },
    {
      icon: "star",
      title: "Opiniones de expertos",
      body: "Nuestros tipsters tienen años de experiencia cubriendo fútbol sudamericano, europeo y más.",
    },
    {
      icon: "users",
      title: "Comunidad activa",
      body: "Únete a miles de aficionados que ya siguen nuestros pronósticos y estrategias cada semana.",
    },
    {
      icon: "bolt",
      title: "Actualizaciones en tiempo real",
      body: "Resultados, cuotas y noticias actualizados al instante para que no te pierdas ningún detalle.",
    },
    {
      icon: "globe",
      title: "Cobertura internacional",
      body: "Liga Chilena, Copa Libertadores, Champions League y más: cubrimos los torneos que te importan.",
    },
  ],
...
const faqDefault: PfContentBlockFaqProps = {
  variant: "faq",
  ...
  intro: "Cada reseña que publicamos es el resultado de horas de investigación, pruebas reales y análisis comparativo. Estos son los criterios que más peso tienen en nuestra puntuación:",
  items: [
    {
